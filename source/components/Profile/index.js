      ...
      <TopBar title={'Profile'} onMenuPress={this.props.navigation.toggleDrawer}>
        <View style={styles.bg}>
          ...
          <View style={styles.profileItem}>
            ...
            <View style={{flex: 3}}>
              <TextInput style={styles.text} value={this.state.name} onChangeText={(text) => {this.setState({name: text})}}/>
            </View>
          </View>
          ...
          <View style={styles.profileItem}>
            ...
            <View style={{flex: 3}}>
              <TextInput style={styles.text} keyboardType={'numeric'} value={this.state.age} onChangeText={(text) => {this.setState({age: text})}}/>
            </View>
          </View>

          <View style={{...styles.profileItem, flexDirection: 'column'}}>
            <Text style={{...styles.label, ...styles.text}}>Gender:</Text>
            <RadioButtons options={['Male', 'Female', 'Prefer not to answer']} selected={this.state.selected} select={(selected) => { this.setState({selected}) }} />
          </View>
